...
4. `docs/rounds/ACS-00.md` — current round contract.
...
- Current round: `ACS-00`
- Current round status: `READY`

ACS-00 is a capability spike only. Do not begin ACS-01 or any later round without a separate explicit execution instruction.
